            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, dbconn.query(sql, [o.user_id, o.status])];
                    case 2:
                        result = _a.sent();
                        dbconn.release();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not find order ".concat(id, ": ").concat(err_3.message));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not update order: ".concat(err_4.message));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Could not delete order ".concat(err_5.message));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrderModel.prototype.addProductToOrder = function (p) {
        return __awaiter(this, void 0, void 0, function () {
            var dbconn, sql, result, err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        err_6 = _a.sent();
                        throw new Error("Could not add product to Order: ".concat(err_6));
                    case 4: return [2 /*return*/];
                }
            });
        });
