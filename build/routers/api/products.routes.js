...
routes.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                err_1 = _a.sent();
                res.status(500).json({ message: "Could not create Product ".concat(err_1) });
                return [3 /*break*/, 3];
...
routes.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productModel.getAllProduct()];
            case 1:
                Products = _a.sent();
                res.json({
                    data: Products,
            ...
            case 2:
                err_2 = _a.sent();
                res.status(500).json({ message: "Can not get all Products ".concat(err_2) });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
routes.patch('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                err_4 = _a.sent();
                res.status(500).json({ message: "Can not update this Product : ".concat(err_4) });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
routes.delete('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                err_5 = _a.sent();
                res.status(500).json({ message: "could not delete Product: ".concat(err_5) });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
